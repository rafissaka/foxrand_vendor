...
class AboutFoxarand extends StatefulWidget {
  const AboutFoxarand({super.key});

  @override
  State<AboutFoxarand> createState() => _AboutFoxarandState();
}

class _AboutFoxarandState extends State<AboutFoxarand> {
  bool isOpened = false;
        ...
        body: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child:
              ...
              ListTile(
                  title: Text(
                    "Where can I find Foxrand’s office",
                    style: TextStyle(
                      fontSize: 15.sp,
              ...
              ListTile(
                  onTap: () {
                    Get.to(() => const LogisticPage());
                  },
                  title: Text(
                    "Where does Foxrand operate",
                    style: TextStyle(
                      fontSize: 15.sp,
                      fontWeight: FontWeight.w500,
                      height: 1.2125.h,
