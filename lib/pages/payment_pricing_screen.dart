...
class PaymentAndPricingScreen extends StatefulWidget {
  const PaymentAndPricingScreen({super.key});

  @override
  State<PaymentAndPricingScreen> createState() =>
      _PaymentAndPricingScreenState();
}

class _PaymentAndPricingScreenState extends State<PaymentAndPricingScreen> {
  bool isOpened = false;
        ...
        body: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child:
              ...
              ListTile(
                  title: Text(
                    "How to use the business payment method",
                    style: TextStyle(
                      fontSize: 15.sp,
              ...
              ListTile(
                  title: Text(
                    "I was charged twice for the same tripe",
                    style: TextStyle(
                      fontSize: 15.sp,
                      fontWeight: FontWeight.w500,
                      height: 1.2125.h,
              ...
              ListTile(
                  title: Text(
                    "How do I take money from my account Balance",
                    style: TextStyle(
                      fontSize: 15.sp,
                      fontWeight: FontWeight.w500,
                      height: 1.2125.h,
