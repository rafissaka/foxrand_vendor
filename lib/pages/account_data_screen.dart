        ...
        body: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child:
              ...
              ListTile(
                  title: Text(
                    "Sign up to deliver food with Foxrand",
                    style: TextStyle(
                      fontSize: 15.sp,
                      fontWeight: FontWeight.w500,
                      height: 1.2125.h,
              ...
              ListTile(
                  title: Text(
                    "Sign up to be a Foxrand courier",
                    style: TextStyle(
                      fontSize: 15.sp,
                      fontWeight: FontWeight.w500,
                      height: 1.2125.h,
              ...
              ListTile(
                  title: Text(
                    "Recieving unwanted Marketing messages ",
                    style: TextStyle(
                      fontSize: 15.sp,
                      fontWeight: FontWeight.w500,
                      height: 1.2125.h,
              ...
              ListTile(
                  title: Text(
                    "Requesting a copy of my Foxrand data",
                    style: TextStyle(
                      fontSize: 15.sp,
                      fontWeight: FontWeight.w500,
                      height: 1.2125.h,
